namespace DeviceManager.Api.Helpers
{
    ...
    public static class Constants
    {
        ...
        /// Name of the connection string
        /// </summary>
        public const string TenantDbConnection = nameof(TenantDbConnection);
        ...
        public const string PMSDB = "TCLC";
        

        /// <summary>
        /// Name of the device database tenant 2
        /// </summary>
        public const string DeviceDbTenant2 = "Test1";
        ...
        /// Guid of the first tenant
        /// </summary>
        public const string JWTConfigSettings ="JwtConfigurationOptions";
    }
}
